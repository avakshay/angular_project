...
<table style={{display:'none'}}>
    ...
    <tbody><tr id="tempTr">
        <td class="align-L">
            ...
            <a href="javascript:void(0);"><span id="_eventType"></span>
                <img class="fromto" src="/images/transparent.gif"/>
                <strong id="_eventName"></strong></a>
        </td>
        <td id="_stake"></td>
...
{/* <!-- Report Table --> */}
<div id="reportDiv" class="over-wrap" style={{maxHeight: 'calc(100% - 32px - 93px)'}}>
    <table id="table_DL" class="table01 table-pt" style={{display:'none'}}>
        <tbody><tr id="head">
            <th id="header_eventName" width="" class="align-L">UID</th>
